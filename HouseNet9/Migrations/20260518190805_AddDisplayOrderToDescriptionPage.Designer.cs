...
namespace HouseNet9.Migrations
{
    ...
    [Migration("20260518190805_AddDisplayOrderToDescriptionPage")]
    partial class AddDisplayOrderToDescriptionPage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Data.HouseRentalData.Address", b =>
                {
                    ...
                    b.Property<bool>("IsHouseAddress")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Data.Data.HouseRentalData.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.Data.HouseRentalData.CommentAccessToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.Data.HouseRentalData.Contact", b =>
                {
                    b.Property<int>("ContactId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Data.Data.HouseRentalData.EmailAddress", b =>
                {
            ...
            modelBuilder.Entity("Data.Data.HouseRentalData.HouseSettings", b =>
                {
                    ...
                    b.Property<string>("BankAccountSwift")
                        .HasMaxLength(11)
            ...
            modelBuilder.Entity("Data.Data.HouseRentalData.RentalHouse", b =>
                {
                    ...
                    b.Property<bool>("DepositReminderSent")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("RemainingReminderSent")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Data.Data.HouseRentalData.SiteSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CookiesPolicy")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Data.Data.HouseRentalData.Address", b =>
                {
                    b.HasOne("Data.Data.HouseRentalData.Contact", "Contact")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("Data.Data.HouseRentalData.CommentAccessToken", b =>
                {
                    b.HasOne("Data.Data.HouseRentalData.Comment", "Comment")
                        .WithMany()
            ...
            modelBuilder.Entity("Data.Data.HouseRentalData.House", b =>
                {
                    b.HasOne("Data.Data.HouseRentalData.HouseSettings", "Settings")
                        .WithMany("Houses")
